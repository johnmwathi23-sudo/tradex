...
const accounts = [
  {
    ...
    spread: "from 1.2",
    spreadLabel: "pip",
    features: ["No commission", "Market execution", "Fixed & floating spreads", "MT4/MT5 support", "Minimum deposit $10"],
    popular: false,
  },
  {
    name: "ECN",
    ...
    spread: "from 0.0",
    spreadLabel: "pip",
    features: ["Raw spreads", "No dealing desk", "Deep liquidity", "Scalping allowed", "Minimum deposit $50"],
    popular: true,
  },
  {
    name: "PRO",
